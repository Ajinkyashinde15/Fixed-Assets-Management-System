...
public class DisplayInsurance {

	JFrame frame;
	private JTable tbpat;
	String head2[] ={ "AssetId ","Insurer","Renewal Date","Policy Number","Manager"};
	...
	public static void main(String[] args) {
   		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DisplayInsurance window = new DisplayInsurance();
	...
	public void showRecords()
	{
		...
		try
		{
			...
			ResultSet r1;
			r1 = st.executeQuery("select * from insurence");
