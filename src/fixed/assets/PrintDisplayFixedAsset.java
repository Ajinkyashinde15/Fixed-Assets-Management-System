...
public class PrintDisplayFixedAsset {
	...
	public static void main(String[] args) {
   		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PrintDisplayFixedAsset window = new PrintDisplayFixedAsset();
	...
	public PrintDisplayFixedAsset() {
		...
		btnNewButton.setBounds(379, 381, 89, 23);
		...
		button.setBounds(224, 381, 89, 23);
